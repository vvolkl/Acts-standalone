...
{
  double px = std::stof(std::string(argv[1]));
  ...
  // second example: use propagator to generate pseudo-hits
  {
    ...
    std::ofstream hits_file("hits_" + std::string(argv[1])  +  "GeV.txt");
